...
from constants import (
    ...
    CAGE_LINE_WIDTH, CAGE_LINE_SHIFT, CAGE_DASH, CAGE_PAD,
    BG, GRID_COLOR, NOTE_COLOR, HILITE, SELECT, FIXED_FG, USER_FG, ERR_FG, CAGE_SUM_FG,
...
class KillerSudokuApp:
    ...
    def draw_notes(self, r, c, notes):
        ...
        for n in range(1, 10):
            if n in notes:
                ...
                self.canvas.create_text(px, py, text = str(n), font = FONT_NOTE, fill = NOTE_COLOR)
    ...
    def draw_total(self):
        ...
        for ((top_left_x, top_left_y), text) in self.cage_data:
            ...
            tx = x0 + top_left_x * CELL_SIZE
            ty = y0 + top_left_y * CELL_SIZE
            ...
            color = (
                ...
                if top_left_x == sr or top_left_y == sc or (top_left_x // 3, top_left_y // 3) == (sr // 3, sc // 3)
                else BG)
